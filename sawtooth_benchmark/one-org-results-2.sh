...
transaction=50
batch=$(($transaction/$txperbatch))
cmd="/binary/v2/autavail-go register 123456 --url="http://sawtooth-rest-api-default-0:8008""
...
do
	...
	do #4 8 16 32 64 do
		...
		do
			sleep 0.1 ; docker exec sawtooth-shell-default-$i ./scripts/send_transactions_2.sh $path $transaction $client $batch 3 & 	
		done
